...
var app = (0, _express2.default)(); // Serves as the entry point for our server webpack configuration


app.use(_express2.default.static('public')); // This tells express to treat this as a static file that is available to the outside world
...
var Home = function Home() {
	return _react2.default.createElement(
		...
		_react2.default.createElement(
			'p',
			null,
			'Home Component Pimps'
		),
		_react2.default.createElement(
			'button',
			{ onClick: function onClick() {
					return console.log('Vape nations');
				} },
			'Touch me'
		)
	);
...
exports.default = function () {
	...
	return store;
}; // This redux will be served on the server.
